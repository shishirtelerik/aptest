...
(function() {
    var provider = app.data.astutePoolBackend = new Everlive({
            offlineStorage: true,
            apiKey: '7t14dTbwPV9cQ5sM',
    ...
    document.addEventListener('online', function() {
        app.data.astutePoolBackend.offline(false);
        app.data.astutePoolBackend.sync();
    });

    document.addEventListener('offline', function() {
        app.data.astutePoolBackend.offline(true);
    });

}());

// START_CUSTOM_CODE_astutePoolBackend
// END_CUSTOM_CODE_astutePoolBackend